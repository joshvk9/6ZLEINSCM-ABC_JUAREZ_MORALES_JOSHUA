...
//vamos a crear un ejemplo de una liata que puede contener un dato y manejo de apuntadores
...
#include<iostream>
/*
Conio es una libreria que da una extension a stdio, como libreria standar, para el
manejo de consola usando comando como getch(), clrscr(), gotoxy(), textcolor(), 
y otras stdlib es una libreria standar para el manejo de funciones de busqueda, ordenamiento,
arboles, pilas, colas, listas nos sirve para las estructuras de datos
*/

using namespace std;

//definimos la lista acorde a un nodo, el acceso, el dato, el apuntador y sig
